# @devtea2027/delectus-itaque-placeat-omnis

[![NPM Package Version](https://img.shields.io/npm/v/@devtea2027/delectus-itaque-placeat-omnis)](https://www.npmjs.com/package/@devtea2027/delectus-itaque-placeat-omnis)
[![Build Status](https://github.com/devtea2027/delectus-itaque-placeat-omnis/workflows/CI/badge.svg)](https://github.com/devtea2027/delectus-itaque-placeat-omnis/actions?query=workflow%3ACI)
...
```
npm i @devtea2027/delectus-itaque-placeat-omnis
```
...
const SonicBoom = require('@devtea2027/delectus-itaque-placeat-omnis')
...
* `retryEAGAIN(err, writeBufferLen, remainingBufferLen)`: a function that will be called when @devtea2027/delectus-itaque-placeat-omnis
    write/writeSync/flushSync encounters a EAGAIN or EBUSY error. If the return value is
    true @devtea2027/delectus-itaque-placeat-omnis will retry the operation, otherwise it will bubble the
    error. `err` is the error that caused this function to be called,
    `writeBufferLen` is the length of the buffer @devtea2027/delectus-itaque-placeat-omnis tried to write, and
    `remainingBufferLen` is the length of the remaining buffer @devtea2027/delectus-itaque-placeat-omnis didn't try to write.
